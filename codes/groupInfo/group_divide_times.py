...
def main(dataset):
    ...
    with open("../../data/%s/group_adj_matrix_multi.pkl" % dataset, "wb") as f:
        pickle.dump(total_adj_matrix, f)
    with open("../../data/%s/node_group_one_hot_vector_multi.pkl" % dataset, "wb") as f:
        pickle.dump(total_node_group_one_hot_vector, f)
